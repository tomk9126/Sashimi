...
class CarnivalManager: ObservableObject {
    ...
    func createCarnival(name: String) -> Carnival {
        let newCarnival = Carnival(name: name)
    ...
    func exampleUsage() {
        ...
        let carnival1 = CarnivalManager.shared.createCarnival(name: "Summer Carnival")
        ...
        let carnival2 = CarnivalManager.shared.createCarnival(name: "Winter Carnival")
